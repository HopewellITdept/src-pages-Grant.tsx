  ...
  <tr>
    <td align="center" valign="top" width="25%">
      <a href="https://arcgis.com" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/VA%20museum.jpg" alt="Photo of a VA Museum ad" width="200" style="max-width: 100%; border-radius: 8px;" title="VA250 - Hopewell Mobile Museum" />
        <br />
    ...
    <td align="center" valign="top" width="25%">
      <a href="https://arcgis.com" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/Ships-offshore_r.jpg" alt="Photo of a ship" width="200" style="max-width: 100%; border-radius: 8px;" title="City Point Historic District Walking Tour" />
        <br />
    ...
    <td align="center" valign="top" width="25%">
      <a href="https://arcgis.com" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/War-2.jpg" alt="Photo of war generals" width="200" style="max-width: 100%; border-radius: 8px;" title="War Stories and Heroes of Hopewell, Virginia" />
        <br />
    ...
    <td align="center" valign="top" width="25%">
      <a href="https://hopewellva250-events.org" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/Grant.jpg" alt="Photo of a General Grant" width="200" style="max-width: 100%; border-radius: 8px;" title="General Ulysses S. Grant at City Point" />
        <br />
  ...
  <tr>
    <td align="center" valign="top">
      <a href="https://wordpress.com" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/HHF%20banner-2.jpg" alt="Historic Hopewell Foundation: A Celebration of America’s 250 banner" width="200" style="max-width: 100%; border-radius: 8px;" title="Historic Hopewell Foundation: A Celebration of America’s 250" />
        <br />
    ...
    <td align="center" valign="top">
      <a href="https://wordpress.com" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/Hooray%20for%20Hopewell%20History%20Image.png" alt="Photo of a Hopewell History event" width="200" style="max-width: 100%; border-radius: 8px;" title="Hooray for Hopewell History" />
        <br />
    ...
    <td align="center" valign="top">
      <a href="https://www.youtube.com/shorts/C39nycwtLf8" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/Appomattox%20Manor%202.png" alt="Photo of a Appoomattox Manor" width="200" style="max-width: 100%; border-radius: 8px;" title="Appomattox Manor" />
        <br />
    ...
    <td align="center" valign="top">
      <a href="https://youtube.com" target="_blank" rel="noopener noreferrer">
        <img src="/lovable-uploads/Weston%20Manor%20-2.jpg" alt="Photo of a Weston Manor" width="200" style="max-width: 100%; border-radius: 8px;" title="Weston Manor" />
        <br />
